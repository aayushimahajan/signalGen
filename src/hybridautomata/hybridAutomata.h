...
public:
	...
	/*
	 * For a given location name, get the location id of this automaton
	 */
	unsigned int getLocationID(string loc_name);

	/*
	 * For a given location id, get the location name of this automaton
	 */
	std::string getLocationName(unsigned int loc_id);

	/*
	 * Get a list of all the transition in this automaton
	 */
	std::list<transition::ptr> get_all_transition();
};
